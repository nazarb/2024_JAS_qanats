    ...
    def __init__(self, size=640):
        ...
        try:
            ...
            T = [
                ...
                ##A.Downscale (scale_min=0.25, scale_max=0.25, interpolation=3, always_apply=False, p=0.5),
                ...
                #A.RandomFog(fog_coef_lower=0.2, fog_coef_upper=0.3, alpha_coef=0.1, p=0.5),
                ##A.GaussNoise (var_limit=(10.0, 50.0), mean=0, per_channel=True, always_apply=False, p=0.5),
                ##A.Perspective (scale=(0.06, 0.1), keep_size=True, pad_mode=0, pad_val=0, mask_pad_val=0, fit_output=False, interpolation=1, always_apply=False, p=0.5),
                ]  # transforms
